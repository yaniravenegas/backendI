...
public class TurnosTestIntegracion {
    ...
    public void cargarDatos(){
        ...
        // Asume que `hora` es opcional y usa el constructor sin `hora`
        TurnoDTO turnoDTO = turnoService.registrarTurno(new Turno(paciente, odontologo, LocalDate.of(2024,9,21), LocalTime.of(10, 0)));
    }
    @Test
